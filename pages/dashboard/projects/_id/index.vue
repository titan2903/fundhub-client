    ...
    <div class="project-page">
      ...
      <section class="container mx-auto pt-8">
        ...
        <div class="grid grid-cols-4 gap-4 -mx-2">
          <div class="relative w-full bg-white m-2 p-2 border border-gray-400 rounded" v-for="image in campaign.data.images" :key="image.image_url">
...
export default {
  ...
  methods: {
    ...
    async upload(file) {
      ...
      try {
        let response = await this.$axios.post('/api/v1/campaign-image', formData, {
          headers: {
